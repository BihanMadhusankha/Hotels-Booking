...
<body>
    ...
    <div class="booknoweka">
        <input class="odersubmit" type="submit" value="BOOK NOW">
    </div>
    <!-- ---------------------------- -->
    ...
    <div class="allcatagory">
        ...
        <img class="catagory1" src="../assets/room1.jpeg" alt="ROOM">
        <img class="catagory1" src="../assets/room2.jpeg" alt="room">
        <img class="catagory1" src="../assets/room3.jpeg" alt="ROOM">
        <img class="catagory1" src="../assets/room4.jpeg" alt="ROOM">
